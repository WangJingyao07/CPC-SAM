...
class Synapse_dataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        mask_img_root = self.train_file.replace('/Images', '/Masks')
        img_id = self.sample_list[idx].split(".")[0]
        label = np.load(mask_img_root + img_id + ".npy")
...
if __name__ == "__main__":
    root_path = "/media/wjy/C/dataset/BBBC038v1/Images/"
