...
parser.add_argument('--root_path', type=str, default='./data/train/Images', help='root dir for data')
...
parser.add_argument('--prompt_base_lr', type=float, default=0.001, help='prompt learning rate')
...
if __name__ == "__main__":
    ...
    sam, img_embedding_size = sam_model_registry[args.vit_name](image_size=args.img_size,
                                                                ...
                                                                return_prompt=False, return_prompt_weight=True)
