...
parser.add_argument('--root_path', type=str, default='/data/users/wjy/cpc_sam/data/train/Images', help='root dir for data')
parser.add_argument('--output', type=str, default='./output')
parser.add_argument('--dataset', type=str, default='brow', help='experiment_name')
