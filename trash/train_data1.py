...
from trainer_file.trainer_my_v2 import trainer
import time


parser = argparse.ArgumentParser()
parser.add_argument('--root_path', type=str, default="/data/wjy_data/CelebAMask-HQ/", help='root dir for data')
parser.add_argument('--output', type=str, default='./output')
parser.add_argument('--dataset', type=str, default='data1', help='experiment_name')
parser.add_argument('--num_classes', type=int, default=18, help='output channel of network')
...
parser.add_argument('--ckpt', type=str, default='/data/users/wjy/cpc_sam/checkpoint/sam_vit_b_01ec64.pth', help='Pretrained checkpoint')
...
parser.add_argument('--num_data', type=int, default=30000, help='batch_size per gpu')
