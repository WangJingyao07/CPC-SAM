...
from trainer_teeth import trainer
import time
...
def main(lr1=0.005, lr2=0.005):
    ...
    parser.add_argument('--root_path', type=str,
                        default='/media/wjy/C/dataset/jsrt/archive/Dental_dataset/'
                                'Childrens dental caries segmentation dataset/Test/Images/', help='root dir for data')
    parser.add_argument('--valid_root_path', type=str,
                        default='/media/wjy/C/dataset/jsrt/archive/Dental_dataset/'
                                'Childrens dental caries segmentation dataset/Train/Images', help='root dir for data')
    ...
    trainer(args, net, snapshot_path, multimask_output, low_res, test_num=-70)
