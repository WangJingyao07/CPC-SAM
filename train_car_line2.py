...
def main(lr1=0.005, lr2=0.005, weight_decay=0.1, weight_decay_p=0.1):
    parser = argparse.ArgumentParser()
    parser.add_argument('--root_path', type=str, default=
    '/media/wjy/C/dataset/car-segmentation/images/', help='root dir for data')
...
if __name__ == "__main__":
    ...
    for w_d_p in w_d_p_list:
        ...
        main(lr_1, lr_2, weight_decay_p=w_d_p)
        print("weight decay prompt=", w_d_p)
