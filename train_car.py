...
def main(lr1=0.005, lr2=0.005, weight_decay=0.5, weight_decay_p=0.1):
    ...
    parser.add_argument('--num_data', type=int, default=16, help='batch_size per gpu')
    ...
    parser.add_argument('--prompt_weight_decay', type=float, default=weight_decay_p, help='weight decay')
    ...
    trainer(args, net, snapshot_path, multimask_output, low_res, test_num=-100)
...
if __name__ == "__main__":
    ...
    #     print("lr=", lr_)
    #     main(lr_, lr_)
    # w_d_p_list = np.arange(0.1, 1.01, 0.01)
    # for w_d_p in w_d_p_list:
    #     print("#########" * 5)
    #     print("weight decay prompt=", w_d_p)
    # main(lr_1, lr_2, weight_decay_p=0.5, weight_decay=0.5)
    # print("weight decay prompt=", w_d_p)
    main(lr_1, lr_2)
