...
def build_sam_vit_h(image_size, num_classes, pixel_mean=[123.675, 116.28, 103.53], pixel_std=[58.395, 57.12, 57.375],
                    checkpoint=None, return_attn=False, return_prompt=False, return_prompt_weight=True):
    return _build_sam(
        ...
        pixel_std=pixel_std, return_attn=False, return_prompt=return_prompt,
        return_prompt_weight=return_prompt_weight
    )
...
def build_sam_vit_l(image_size, num_classes, pixel_mean=[123.675, 116.28, 103.53], pixel_std=[58.395, 57.12, 57.375],
    ...
    return _build_sam(
        ...
        image_size=image_size,
        pixel_mean=pixel_mean,
        pixel_std=pixel_std, return_attn=return_attn, return_prompt=return_prompt,
        return_prompt_weight=return_prompt_weight
    )
