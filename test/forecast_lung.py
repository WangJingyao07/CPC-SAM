...
def main(lr1=0.005, lr2=0.005):
    ...
    parser.add_argument('--root_path', type=str,
                        default='/media/wjy/C/dataset/lung/segmentation02/segmentation/Images/',
                        help='root dir for data')
    parser.add_argument('--return_all', type=bool,
                        default=True,
                        help='')
    parser.add_argument('--output', type=str, default='./saved_model/temp/')
    parser.add_argument('--dataset', type=str, default='lung', help='experiment_name')
    ...
    # gt_img_save_root = "../imgs/lung/4/gt/"
    # pred_img_save_root = "../imgs/lung/4/pred/"
    # origin_img_save_root = "../imgs/lung/4/img/"
    # model_path = ("/media/wjy/D/python_code/"
    #               "cpc_sam/saved_model/lung/best_model/338008_4.pth")

    gt_img_save_root = "../imgs/lung/8/gt/"
    pred_img_save_root = "../imgs/lung/8/pred/"
    origin_img_save_root = "../imgs/lung/8/img/"
    model_path = ("/media/wjy/D/python_code/"
                  "cpc_sam/saved_model/lung/best_model/850975_8.pth")
