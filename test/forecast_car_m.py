...
from forecast_utils1 import trainer, test
import time
...
def main(lr1=0.005, lr2=0.005):
    ...
    parser.add_argument('--root_path', type=str,
                        default='/media/wjy/C/dataset/car-segmentation/images/',
                        help='root dir for data')

    # # 训练深海数据集
    # parser.add_argument('--root_path', type=str,
    #                     default='/media/wjy/C/dataset/undersea/dataset/original_data/images/',
    #                     help='root dir for data')
    ...
    parser.add_argument('--dataset', type=str, default='car_m', help='experiment_name')
    ...
    sam, img_embedding_size = sam_model_registry[args.vit_name](image_size=args.img_size,
                                                                ...
                                                                pixel_std=[1, 1, 1], return_attn=False,
                                                                return_prompt=False,
                                                                return_prompt_weight=True)
    ...
    # gt_img_save_root = "../imgs/car/2/gt/"
    # pred_img_save_root = "../imgs/car/2/pred/"
    # origin_img_save_root = "../imgs/car/2/img/"
    # model_path = ("/media/wjy/D/python_code/"
    #               "cpc_sam/saved_model/car_m/best_model/646776_2.pth")

    # gt_img_save_root = "../imgs/car/4/gt/"
    # pred_img_save_root = "../imgs/car/4/pred/"
    # origin_img_save_root = "../imgs/car/4/img/"
    # model_path = ("/media/wjy/D/python_code/"
    #               "cpc_sam/saved_model/car_m/best_model/159750_4.pth")

    gt_img_save_root = "../imgs/undersea/gt/"
    pred_img_save_root = "../imgs/undersea/pred/"
    origin_img_save_root = "../imgs/undersea/img/"
    model_path = ("/media/wjy/D/python_code/"
                  "cpc_sam/saved_model/car_m/974820.pth")
    ...
    test(args, net, snapshot_path, multimask_output, low_res, model_path=model_path,
         img_save_root1=gt_img_save_root, img_save_root2=pred_img_save_root,
         img_save_root3=origin_img_save_root, test_num=-100)
