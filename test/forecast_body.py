...
def main(lr1=0.005, lr2=0.005):
    ...
    parser.add_argument('--root_path', type=str,
                        default='../data/train/Images', help='root dir for data')

    # # 训练息肉数据集
    # parser.add_argument('--root_path', type=str,
    #                     default='/media/wjy/C/dataset/Kvasir-SEG/Images',
    ...
    parser.add_argument('--dataset', type=str, default='body', help='experiment_name')
    ...
    # gt_img_save_root = "../imgs/body/4/gt/"
    # pred_img_save_root = "../imgs/body/4/pred/"
    # origin_img_save_root = "../imgs/body/4/img/"
    # model_path = ("/media/wjy/D/python_code/cpc_sam/"
    #               "saved_model/body/best_model/844368_4.pth")

    # gt_img_save_root = "../imgs/body/8/gt/"
    # pred_img_save_root = "../imgs/body/8/pred/"
    # origin_img_save_root = "../imgs/body/8/img/"
    # model_path = ("/media/wjy/D/python_code/cpc_sam/"
    #               "saved_model/body/best_model/101871_8.pth")

    # 息肉数据集
    gt_img_save_root = "../imgs/xirou/gt/"
    pred_img_save_root = "../imgs/xirou/pred/"
    origin_img_save_root = "../imgs/xirou/img/"
    model_path = ("/media/wjy/D/python_code/cpc_sam/"
                  "saved_model/body/481754.pth")
