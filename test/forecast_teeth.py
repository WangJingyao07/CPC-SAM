...
from forecast_utils1 import test
...
def main(lr1=0.005, lr2=0.005):
    ...
    parser.add_argument('--root_path', type=str,
                        default='/media/wjy/C/dataset/jsrt/archive/Dental_dataset/'
                                'Childrens dental caries segmentation dataset/Train/Images',
                        help='root dir for data')
    parser.add_argument('--return_all', type=bool,
                        default=True,
                        help='')
    parser.add_argument('--output', type=str, default='./saved_model/temp/')
    parser.add_argument('--dataset', type=str, default='teeth', help='experiment_name')
    ...
    # gt_img_save_root = "../imgs/teeth/4/gt/"
    # pred_img_save_root = "../imgs/teeth/4/pred/"
    # origin_img_save_root = "../imgs/teeth/4/img/"
    # model_path = ("/media/wjy/D/python_code/"
    #               "cpc_sam/saved_model/teeth/best_model/93536_4.pth")

    gt_img_save_root = "../imgs/teeth/8/gt/"
    pred_img_save_root = "../imgs/teeth/8/pred/"
    origin_img_save_root = "../imgs/teeth/8/img/"
    model_path = ("/media/wjy/D/python_code/"
                  "cpc_sam/saved_model/teeth/best_model/676272_8.pth")
    ...
    test(args, net, snapshot_path, multimask_output, low_res, model_path=model_path,
         ...
         img_save_root3=origin_img_save_root, test_num=-100000)
