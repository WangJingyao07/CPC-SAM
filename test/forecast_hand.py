...
def main(lr1=0.005, lr2=0.005):
    ...
    parser.add_argument('--root_path', type=str,
                        default='/media/wjy/C/dataset/hand2K/GTEA/images/',
    ...
    parser.add_argument('--dataset', type=str, default='hand', help='experiment_name')
    ...
    gt_img_save_root = "../imgs/hand/gt/"
    pred_img_save_root = "../imgs/hand/pred/"
    origin_img_save_root = "../imgs/hand/img/"
    model_path = ("/media/wjy/D/python_code/"
                  "cpc_sam/saved_model/hand/369507.pth")
